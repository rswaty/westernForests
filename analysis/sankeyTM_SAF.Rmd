---
title: "Sankey comparing TreeMap to EVT (SAF_SRM attribute)"
...
We hope you like brown 'cause we aren't changing it.  Brown (aka "Hazel") likes it.


```{r states, echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("assets/brown.JPG", error = FALSE)
```
...
# read in snkyPdata
snkyPdata <- read_csv("data/sankey80-80saf.csv")
...
DT80 <- read_csv("data/sankey80-80saf.csv")
library(DT)
datatable(DT80,
